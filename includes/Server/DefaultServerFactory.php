...
use ShimMcp\Server\Infrastructure\ErrorHandling\ErrorLogMcpErrorHandler;
use ShimMcp\Server\Infrastructure\Observability\NullMcpObservabilityHandler;
use ShimMcp\Server\Transport\HttpTransport;
...
class DefaultServerFactory {
	...
	public static function create(): void {
		...
		$wordpress_defaults = array(
			'server_id'              => 'shim-mcp-server',
			'server_route_namespace' => 'mcp',
			'server_route'           => 'shim-mcp',
			'server_name'            => 'Shim MCP',
			'server_description'     => 'All-in-one MCP server for WordPress',
			'server_version'         => SHIM_MCP_VERSION,
			...
			'tools'                  => array(
				'shim-mcp/discover-abilities',
				'shim-mcp/get-ability-info',
				'shim-mcp/execute-ability',
			),
