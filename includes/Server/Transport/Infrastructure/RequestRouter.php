...
class RequestRouter {
	 ...
	 *
	 * @var \ShimMcp\Server\Transport\Infrastructure\McpTransportContext
	 */
	 ...
	 *
	 * @param \ShimMcp\Server\Transport\Infrastructure\McpTransportContext $context The transport context.
	 */
	 ...
	 * @param \ShimMcp\Server\Transport\Infrastructure\HttpRequestContext|null $http_context HTTP context for session management.
	 *
	 * @return array
	 */
	...
	private function handle_initialize_with_session( array $params, $request_id, ?HttpRequestContext $http_context ): array {
		// Get the initialize response from the handler (pass params for version negotiation)
		$result = $this->context->initialize_handler->handle( $request_id, $params );
