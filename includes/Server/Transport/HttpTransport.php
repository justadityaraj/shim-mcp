...
namespace ShimMcp\Server\Transport;

use ShimMcp\Server\Transport\Contracts\McpRestTransportInterface;
use ShimMcp\Server\Transport\Infrastructure\HttpRequestContext;
use ShimMcp\Server\Transport\Infrastructure\HttpRequestHandler;
use ShimMcp\Server\Transport\Infrastructure\McpTransportContext;
use ShimMcp\Server\Transport\Infrastructure\McpTransportHelperTrait;
...
class HttpTransport implements McpRestTransportInterface {
	 ...
	 *
	 * @var \ShimMcp\Server\Transport\Infrastructure\HttpRequestHandler
	 */
	 ...
	 *
	 * @param \ShimMcp\Server\Transport\Infrastructure\McpTransportContext $transport_context The transport context.
	 */
