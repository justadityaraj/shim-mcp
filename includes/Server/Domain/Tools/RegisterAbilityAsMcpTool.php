...
use ShimMcp\Server\Domain\Utils\McpAnnotationMapper;
use ShimMcp\Server\Domain\Utils\SchemaTransformer;
use WP_Ability;
...
class RegisterAbilityAsMcpTool {
	 ...
	 *
	 * @return \ShimMcp\Server\Domain\Tools\McpTool|\WP_Error The validated MCP tool instance or WP_Error if validation fails.
	 */
