...
use ShimMcp\Server\Domain\Prompts\McpPrompt;
use ShimMcp\Server\Domain\Resources\McpResource;
...
use ShimMcp\Server\Transport\Infrastructure\McpTransportContext;
...
class McpServer {
	 ...
	 *
	 * @var \ShimMcp\Server\McpComponentRegistry
	 */
	 ...
	 *
	 * @var \ShimMcp\Server\McpTransportFactory
	 */
	 ...
	 * @param class-string<\ShimMcp\Server\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface>|null         $error_handler Error handler class to use (e.g., NullMcpErrorHandler::class). Must implement McpErrorHandlerInterface. If null, NullMcpErrorHandler will be used.
	 * @param class-string<\ShimMcp\Server\Infrastructure\Observability\Contracts\McpObservabilityHandlerInterface>|null $observability_handler Observability handler class to use (e.g., NullMcpObservabilityHandler::class). Must implement McpObservabilityHandlerInterface. If null, NullMcpObservabilityHandler will be used.
	...
	private function setup_handlers( ?string $error_handler, ?string $observability_handler ): void {
		...
		if ( $error_handler && class_exists( $error_handler ) ) {
			/** @var \ShimMcp\Server\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface $handler */
		...
		if ( $observability_handler && class_exists( $observability_handler ) ) {
			/** @var \ShimMcp\Server\Infrastructure\Observability\Contracts\McpObservabilityHandlerInterface $handler */
	 ...
	 *
	 * @return \ShimMcp\Server\Infrastructure\Observability\Contracts\McpObservabilityHandlerInterface
	 */
	 ...
	 *
	 * @return \ShimMcp\Server\Domain\Resources\McpResource[]
	 */
	 ...
	 *
	 * @return \ShimMcp\Server\Domain\Tools\McpTool|null
	 */
	 ...
	 *
	 * @return \ShimMcp\Server\Domain\Resources\McpResource|null
	 */
	 ...
	 *
	 * @return \ShimMcp\Server\Domain\Prompts\McpPrompt|null
	 */
	 ...
	 *
	 * @return \ShimMcp\Server\Transport\Infrastructure\McpTransportContext
	 */
	 ...
	 *
	 * @return \ShimMcp\Server\McpComponentRegistry
	 */
